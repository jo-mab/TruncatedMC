      ...
      Double Precision Ran_Uniform,Genrand_Real2
      Integer Iff,T1
      Save Iff
      Data Iff /0/
      ...
      If(Iff.Eq.0)Then
         ...
         Call System_Clock(T1)
         Call Init_Genrand(114)
      Endif

      Ran_Uniform=Genrand_Real2()
...
c     generates a random number on (0,1)-real-interval
c-----------------------------------------------------------------------
c     function genrand_real3()
c     double precision genrand_real3,r
c     integer genrand_int32
c     r=dble(genrand_int32())
c     if(r.lt.0.d0)r=r+2.d0**32
c     genrand_real3=(r+0.5d0)/4294967296.d0
c     return
c     end
c-----------------------------------------------------------------------
